...
<template>
           <div class="sidebar-categores-inner">
                    <div class="filter-group sizefilter">
                       ...
                       <a @click="filterProducts('all',$event)" class="active"><i @click="filterProducts('all',$event)" class="fa fa-check oldmain-b-color "></i> <span class="ml-1">الكل</span></a>                      
...
export default {
     data(){
        return {
            ageProperty :'',
            sizelist: ["العمر 5-6","العمر 7-8","العمر 9-11","12-14 سنة","14- 15 سنة"]
        }
    },
    computed:{
         allproducts(){
