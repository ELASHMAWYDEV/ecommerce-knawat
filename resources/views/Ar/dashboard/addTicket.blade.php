    ...
    <!-- page wapper-->
            <div class="container p-3 bg-white" id="columns">
               ...
               padding: 1.5rem;">
                ...
                <div class="row m-0">
                    <label for="title" class="col-sm-2"><strong>النوع</strong></label>
                    <div class="col-sm-10">
                        <div>
                          <input type="radio" name="type[]" value="r" id="req"><label for="req">طلب</label>

                        </div>
                        <div>
                          <input type="radio" name="type[]" value="p" id="prob"><label for="prob">مشكلة</label> 
                ...
                <div class="row mr-0 ml-0 form-group">
                    <label for="title" class="col-sm-2"><strong>الموضوع</strong></label>
                    <input type="text" class="col-sm-10 form-control" name="title" id="title">
                </div>
                <div class="row mr-0 ml-0 form-group">
                    <label class="col-sm-2" for="content"><strong>المحتوى</strong></label>
                    <textarea name="content" id="content" class="form-control col-sm-10" rows="8"></textarea>
                </div>
                <div class="row mr-0 ml-0 mt-2 form-group">
                    <label class="col-sm-2" for="content"><strong>إرفاق ملف</strong></label>
